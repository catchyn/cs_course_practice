...
function inverse(value) {
    if (typeof value === 'string') {
        return new Promise((resolve) => {
            CanvasUtils.applyEffect(CanvasUtils.inverseEffect, value).then((imageData) => resolve(imageData));
        });
    }
    else {
...
function render(value) {
    if (typeof value === 'string') {
        return new Promise((resolve) => {
            CanvasUtils.applyEffect((imageData) => imageData, value).then((imageData) => resolve(imageData));
        });
    }
    else {
