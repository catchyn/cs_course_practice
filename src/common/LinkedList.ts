...
export class LinkedList<T> {
    ...
    removeFirst(): LinkNode<T> | null {
        const elem = this.first;
        if (this.isEmpty() || this.first?.next === null) {
            this.first = null;
            this.last = null;
        } else if (this.first) {
    ...
    removeLast(): LinkNode<T> | null {
        const elem = this.last;
        if (this.isEmpty() || this.last?.prev === null) {
            this.first = null;
            this.last = null;
        } else if (this.last) {
